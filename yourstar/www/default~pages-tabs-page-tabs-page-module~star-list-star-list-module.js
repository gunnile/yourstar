...
var StarListPage = /** @class */ (function () {
    ...
    StarListPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        this.starListData.load().subscribe(function (data) {
            _this.stars = data.results;
        });
    };
